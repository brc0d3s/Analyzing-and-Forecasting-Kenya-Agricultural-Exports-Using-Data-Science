...
```{r}
# Define trainControl to suppress verbose output
control <- trainControl(method = "cv", number = 5, verboseIter = FALSE)


# Initialize models
models <- list(
    multinom = train(x_train_scaled, y_train, method = "multinom", trControl = control),
    gnb = train(x_train_scaled, y_train, method = "naive_bayes", trControl = control),
    svc = train(x_train_scaled, y_train, method = "svmRadial", trControl = control),
    knn = train(x_train_scaled, y_train, method = "knn", trControl = control),
    dt = train(x_train_scaled, y_train, method = "rpart", trControl = control),
    rf = train(x_train_scaled, y_train, method = "rf", trControl = control)
)
